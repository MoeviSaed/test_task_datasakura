...
public class ReadmeEditor : Editor
{
    ...
    protected override void OnHeaderGUI()
    {
        ...
        float iconWidth = Mathf.Min(EditorGUIUtility.currentViewWidth / 3f - 20f, b: 128f);
    ...
    private void Init()
    {
        ...
        m_LinkStyle.normal.textColor = new Color(0x00 / 255f, 0x78 / 255f, 0xDA / 255f, a: 1f);
    ...
    {
        if (!SessionState.GetBool(s_ShowedReadmeSessionStateName, defaultValue: false))
        {
            Readme readme = SelectReadme();
            SessionState.SetBool(s_ShowedReadmeSessionStateName, value: true);
    ...
    private static void LoadLayout()
    {
        ...
        Type windowLayoutType = assembly.GetType("UnityEditor.WindowLayout", throwOnError: true);
